...
# en requests se puso .get porque es el verbo que estamos usando 
# en app.get("/")

# si hubiese puesto put, patch, update etc entonces sería requests.XXXXX

# esta ruta http://127.0.0.1:8000 sale cuando se levanta uvicorn 
# nos indica porque ruta se esta ejecutando
